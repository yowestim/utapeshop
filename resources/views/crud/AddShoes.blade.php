...
<form action="/shoes/store" method="POST" enctype="multipart/form-data">
    ...
    Image : <div class="input-group control-group increment">
        <input class="form-control" type="file" style="margin-bottom : 20px;" accept=".gif,.jpg,.jpeg,.png" name="filename[]">
    </div>
    <div class="nav navbar-nav navbar-right">
            <button type="button" id="add" class="btn btn-primary" onclick="addV()" style="">Add</button>
        </div>
